...
public class Device1Fragment extends BaseFragment {
    private View view;
...
//    已审核
    ...
    public static Device1Fragment newInstance() {
        Device1Fragment newsFragment = new Device1Fragment();
        return newsFragment;
    }
...
//                        Intent intent = new Intent( getContext(), DetailsActivity.class);
    ...
    public void initData() {
        ...
        ApiUtil.getApiService().IndexLB(""+uid,1,1,start,10)
