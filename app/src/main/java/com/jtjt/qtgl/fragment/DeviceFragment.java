...
//            examineFragment.add(new YExamineFragment());
            ...
            examineFragment.add(Device1Fragment.newInstance());
            examineFragment.add(Device2Fragment.newInstance());
            examineFragment.add(Device3Fragment.newInstance());
        ...
        examineFragment.get(2).setArguments(bundle1);
