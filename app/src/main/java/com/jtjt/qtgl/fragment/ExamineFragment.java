...
//    private List<BaseFragment> fragments;
    ...
    public View onInitView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.examine_fragment, container, false);
...
//            examineFragment.add(new YExamineFragment());
            ...
            examineFragment.add(DExamineFragment.newInstance());
            examineFragment.add(YExamineFragment.newInstance());
        ...
        orderVP.setOffscreenPageLimit(2);
