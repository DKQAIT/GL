...
import com.jtjt.qtgl.activity.TaskdetailsActivity;
import com.jtjt.qtgl.bean.base.ListBaseAdapter;
import com.jtjt.qtgl.bean.base.SuperViewHolder;
import com.jtjt.qtgl.bean.base.TaskBean;
import com.jtjt.qtgl.bean.base.TaskModel;
...
public class Task2Fragment extends BaseFragment {
    ...
    private TaskModel ss;
    private String uid;

//    已审核

    public static Task2Fragment newInstance() {
        Task2Fragment newsFragment = new Task2Fragment();
        return newsFragment;
    }
    ...
    public void initView() {
        ...
        adapter = new ListBaseAdapter<TaskBean>(context) {
            @Override
            ...
            public void onBindItemHolder(SuperViewHolder holder, int position) {
                final TaskBean bean = getDataList().get(position);
...
//                        startAct(TaskdetailsActivity.class,bundle);
//                    }
//                });
    ...
    public void initData() {
        ...
        ApiUtil.getApiService().TaskLB(""+uid,2,1,start,10)
...
//                            JSONObject ss = JSON.parseObject(s, DExamModel.class);
                            ss=JSON.parseObject(s,TaskModel.class);
