...
import com.jtjt.qtgl.fragment.FeedbackFragment;
...
public class FeedbackActivity extends BaseActivity implements NavGroup.OnCheckedChangeListener{
...
//    private List<BaseFragment> fragments;
    ...
    public void initData() {
        ...
        if (examineFragment == null) {
            ...
            examineFragment.add(new FeedbackFragment());
