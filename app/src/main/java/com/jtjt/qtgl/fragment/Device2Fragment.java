...
public class Device2Fragment extends BaseFragment {
    private View view;
...
//    已审核
    ...
    public static Device2Fragment newInstance() {
        Device2Fragment newsFragment = new Device2Fragment();
        return newsFragment;
    }
...
//                        Intent intent = new Intent( getContext(), DetailsActivity.class);
    ...
    public void initData() {
        ...
        Log.e("获取状态","获取22222处理状态"+uid);
        Log.e("获取登录Tojel","获取登录Token"+userBean.getLogintoken());
        ApiUtil.getApiService().IndexLB(""+uid,2,1,start,10)
