...
//    public static void copyAssetFileToNewPath(Context context, String AssetFileName, String filePath) throws IOException {
//        InputStream in;
//        OutputStream out;
...
//            dir.mkdirs();
//        }
//        File fileZip = new File(dir, AssetFileName);
//        if (fileZip.exists()) {
//            fileZip.delete();
//        }
...
//    }
//
//    public static void unzip(File zipFile, String outPath) throws ZipException {
//        ZipFile zFile;
...
//    }
//
//    public static void writeResponseBodyToDisk(ResponseBody body, File file) throws IOException {
...
//    }
//
//    public static File initDownLoadFile(String download_url, String savePath) {
//        String[] str = download_url.split("/");
...
//        File destFileDir = new File(fileName);
