...
public class PinkListActivity   extends BaseActivity {
    /**
     * 停车场列表
     */
    ...
    public void initView() {
        ...
        adapter = new ListBaseAdapter<ParkModel>(context) {
            ...
            {
                return R.layout.parklist_adapter;
            }
            @Override
            public void onBindItemHolder(SuperViewHolder holder, int position) {
                ...
                TextView tccxq = holder.getView(R.id.tccxq);
                tv_name.setText(""+bean.getName());

                tccxq.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Bundle bundle = new Bundle();
                        bundle.putString("UID",bean.getId()+"");
                        Log.e("跳转UID","跳转UID"+bean.getId());
                        startAct(ParkDetailActivity
                                .class,bundle);
                    }
                });
...
//                        Intent intent = new Intent( getContext(), DetailsActivity.class);
                        ...
                        Log.e("跳转UID","跳转UID"+bean.getId());
                        startAct(DeviceActivity.class,bundle);
                    }
                });
...
//                        Intent intent = new Intent( getContext(), DetailsActivity.class);
                        ...
                        bundle.putString("UID",bean.getId()+"");
                        Log.e("跳转UID","跳转UID"+bean.getId());
                        startAct(UserListActivity.class,bundle);
                    }
                });
...
//                        Intent intent = new Intent( getContext(), DetailsActivity.class);
                        ...
                        bundle.putString("UNAME",bean.getName()+"");
                        Log.e("跳转UID","跳转UID"+bean.getId());
                        startAct(UplodeActivity.class,bundle);
                    }
                });
