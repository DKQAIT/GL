...
public class DExamineFragment   extends BaseFragment {
    private View view;
...
//    已审核
    ...
    public static DExamineFragment newInstance() {
        DExamineFragment newsFragment = new DExamineFragment();
        return newsFragment;
    }
...
//                        shenhe(bean.getUid(),0);
    ...
    public void initData() {
        ...
        ApiUtil.getApiService().Dexamin(userBean.getLogintoken(),2,start,10)
