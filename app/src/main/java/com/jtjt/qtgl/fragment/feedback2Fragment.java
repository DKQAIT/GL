...
public class feedback2Fragment extends BaseFragment {
    private View view;
...
//    已审核
    ...
    public static feedback2Fragment newInstance() {
        feedback2Fragment newsFragment = new feedback2Fragment();
        return newsFragment;
    }
...
//                        Intent intent = new Intent( getContext(), DetailsActivity.class);
    ...
    public void initData() {
        ...
        ApiUtil.getApiService().OpinionLB(1,start,10)
